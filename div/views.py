...
def logout(request):
	...
	return HttpResponseRedirect('http://34.93.47.59/index')
...
def home_view(request):
	...
	if request.method=='GET':
		if not request.session.has_key('uname'):			
			...
			post_data = [("grant_type","authorization_code"),("code",name),("client_id","a420ca7d74ada05e8b29411205403ca4"),("client_secret","ab9b1e3c02b7bb2f98080f26372b16f6"),("redirect_uri","http://34.93.47.59/")]     # a sequence of two element tuples
			result=''
			try:
...
def login_view(request):
	if request.session.has_key('uname'):
		if request.session.has_key('token'):
			return HttpResponseRedirect("http://34.93.47.59/home")
	return HttpResponseRedirect("https://api.codechef.com/oauth/authorize?response_type=code&client_id=a420ca7d74ada05e8b29411205403ca4&redirect_uri=http://34.93.47.59/&state=xyz")
